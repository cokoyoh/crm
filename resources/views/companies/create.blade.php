    ...
    <div class="-mx-3 bg-gray-200 overflow-auto">
        <div class="mx-auto px-24 pt-1 pb-6 bg-white shadow-sm">
            ...
            <div class="mt-4 flex items-center justify-between">
                <p class="text-gray-900 text-lg font-medium">Add New Invite</p>
        ...
        <div class="h-screen mx-auto px-24 pt-5">
            <form class="bg-gray-100 px-8 py-5 rounded" method="post" action="{!! route('companies.store') !!}">
                @include('companies.partials.form', [
                    'company' => new \CRM\Models\Company,
