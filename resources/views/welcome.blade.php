...
<section id="header-section" class="bg-cover bg-no-repeat h-auto pb-8"
    ...
    <header class="container mx-auto p-4 flex items-center justify-between mb-12 md:mb-16 bg-transparent">
        ...
        <nav class="flex items-center">
            @guest
                <a href="{!! route('login') !!}"
                   class="md:inline-block text-gray-400 hover:text-gray-100 ml-5">Login</a>
            @else
                <a href="{!! route('home') !!}"
                   class="md:inline-block text-gray-400 hover:text-gray-100 ml-5">Home</a>
            @endguest
            <a href="#"
               class="ml-2 inline-block text-white hover:text-gray-100 text-lg md:text-xl font-medium md:ml-8 mr-5 md:mr-0 px-3 md:px-4 py-2 md:py-3 rounded-lg border border-gray-800 hover:border-gray-500 whitespace-no-wrap">Begin
                Trial</a>
        </nav>
    </header>
